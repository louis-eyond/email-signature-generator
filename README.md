...
**[Try it live →](https://clarke117.github.io/email-signature-generator)**
...
1. Open `index.html` in any modern browser (or visit the [live version](https://clarke117.github.io/email-signature-generator))
